...
\item Criação do hardware e software do dispositivo de diagnóstico em python:
  \begin{itemize}%
  ...
  \item Possui um registro de software para o aparelho
  \end{itemize}
\end{itemize}}
...
\cvitem{Linguagens Fluentes}{Python, HTML/CSS/Javascript/Node}
\cvitem{Linguagens Nível Básico}{Java, C, Scala, Octave, PHP, Ruby}
